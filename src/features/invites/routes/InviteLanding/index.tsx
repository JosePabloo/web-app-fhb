...
// NOTES: Reuses the public invite query cache so the accept step can avoid a second lookup.
...
export default function InviteLanding() {
  ...
  const { data: invite, isPending: loading, isError } = usePublicInviteQuery(inviteId || undefined);
                  ...
                  {!phoneValidated && (
                    <Stack spacing={2}>
                      <Typography variant="body2" color="text.secondary">
                        To continue, please enter the last 4 digits of the phone number used to
                        create this invite.
                      </Typography>
                        ...
                        onChange={(e) => {
                          ...
                          if (value.length <= 4) {
                            ...
                            if (
                              ...
                              validateInvitePhone(inviteId, value)
                                .then((response) => {
                                  if (response.isValid) {
